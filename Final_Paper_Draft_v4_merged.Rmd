...
```
\begin{center}
Figure 31 - Timeseries of smoothed and log transformed daily Covid-19 cases (left) and deaths (right) in the United States.
\end{center}
...
```
\begin{center}
Figure 32 - Heapmaps for the K-shape distances for cases and deaths and geographical distances between states
\end{center}
...
```
\begin{center}
Figure 33 - Scatter plot and fitted regression for the geo distances against the K-shape distances of time series for cases and deaths
\end{center}
...
```
\begin{center}
Figure 34 - Clustering analysis for cases (Upper) and death (Bottom) with k=6
\end{center}
...
```
\begin{center}
Figure 35 - Hierarchical clustering analysis results - binary tree plot for cases (Left) and death (Right)
\end{center}
...
\begin{center}
Figure 36 - The centroid time series for different clusters of cases (upper two rows) and deaths (bottom two rows)
\end{center}
...
With the clutering results, we plotted the cluster membership for each state in a US map. As shown in Figure 37, the 6 clusters is spatially distributed in a systematic and predictable manner. 
...
\begin{center}
Figure 37 - The US state maps color filled by the cluster memebership for case and death growth
\end{center}
